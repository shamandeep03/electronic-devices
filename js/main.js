...
window.addEventListener('scroll', function () {
    var stickyTopElement = document.querySelector('.sticky-top');
    if (stickyTopElement) {
        if (window.scrollY > 300) {
            stickyTopElement.classList.add('shadow-sm');
            stickyTopElement.style.top = '0px';
        } else {
            stickyTopElement.classList.remove('shadow-sm');
            stickyTopElement.style.top = '-100px';
        }
    }
});
...
// Facts counter (no equivalent without using a specific library)
// If you're using a counter plugin, you'll need to find an alternative in plain JavaScript.

// Header carousel (no equivalent without using a specific library)
// If you're using an owl carousel, you'll need to find an alternative in plain JavaScript.

// Displaying products based on conditions
